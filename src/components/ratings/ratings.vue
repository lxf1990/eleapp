<template>
  <div class="ratings" ref="ratings">
    <div class="rating-content">
      ...
      <div class="overview">
        <div class="overview-left"><h1 class="score">{{seller.score}}</h1>
        ...
        <div class="overview-right">
          <div class="score-wrapper"><span class="title">服务态度</span>
            ...
            <star :scroe="seller.serviceScore" :size="36"></star>
    ...
    computed:{
      filterRatings () {
        ...
        return this.ratings.filter(rating => {
          if (selectType===2) {
            return !onlyContent || !!rating.text  //!! 强制转换为布尔值如果onlyContent为false，直接返回true,否则还要看text有没有值
          }else {
            //既要比较type,还有比较content
